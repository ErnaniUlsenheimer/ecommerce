								...
								<div class="col-md-12">
									...
									<div class="woocommerce-billing-fields">
										...
										<div id="order_review" style="position: relative;">
											...
											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
												<input type="radio" checked="checked" id="method-boleto" name="payment-method" placeholder="País" value="3" style="float:left; margin: 30px;">
												<label class="" for="method-boleto"><img style="height:64px;" src="/res/site/img/logo-boleto-1.png"></label>
											</p>
											<div id="payment">
